...
describe('HTML regex', function() {
    it('Should retrieve all tags, open and close.', () => {
        ...
        expect(HTMLParser.getElements(test5).length).toBe(0);
    });
    ...
    it('Should retrieve only closing tags.', () => {
        ...
        expect(HTMLParser.getClosedElements(test5).length).toBe(0);
    });
    ...
    it('Should retrieve only open tags.', () => {
        ...
        expect(HTMLParser.getOpenElements(test5).length).toBe(0);
    });
